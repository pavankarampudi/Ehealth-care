...
public class AddDeceaseServletdoc extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AddDeceaseServletdoc() {
		super();
	}
public void service(HttpServletRequest request, HttpServletResponse response){
		...
		if(n==1){
	        ...
	        RequestDispatcher rd = request.getRequestDispatcher("/successadddeceasedoc.jsp");
	        rd.include(request, response);
	        
		}else{
			//out.println("<center>Sorry not modified<center>");
	        RequestDispatcher rd = request.getRequestDispatcher("/failedadddeceasedoc.jsp");
	        rd.include(request, response);
