...
public class RelationSearchServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public RelationSearchServlet() {
		super();
	}
	...
	public void service(HttpServletRequest request, HttpServletResponse response){
		...
		System.out.println(deceaseName);
	        ...
	        RequestDispatcher rd = request.getRequestDispatcher("./relationdiagram.jsp");
