...
public class DeceaseSearchServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DeceaseSearchServlet() {
		super();
	}
	public void service(HttpServletRequest request, HttpServletResponse response){
		...
		if((deceaseName!=null)&&!deceaseName.equals("")){
	        ...
	        RequestDispatcher rd = request.getRequestDispatcher("/searchdeceaselist.jsp");
			...
			request.setAttribute("list", list);
	        RequestDispatcher rd = request.getRequestDispatcher("/searchdeceaselist1.jsp");
	        rd.forward(request, response);
