...
public class RelationSearchServletusr extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public RelationSearchServletusr() {
		super();
	}
	...
	public void service(HttpServletRequest request, HttpServletResponse response){
		...
		System.out.println(deceaseName);
			...
			ArrayList list=rsjb.relationSearch(deceaseName);
                        ...
                        RequestDispatcher rd = request.getRequestDispatcher("./relationdiagramusr.jsp");
