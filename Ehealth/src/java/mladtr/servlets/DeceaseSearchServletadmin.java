...
public class DeceaseSearchServletadmin extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DeceaseSearchServletadmin() {
		super();
	}
	public void service(HttpServletRequest request, HttpServletResponse response){
		...
		if((deceaseName!=null)&&!deceaseName.equals("")){
	        ...
	        RequestDispatcher rd = request.getRequestDispatcher("/searchdeceaselistadmin.jsp");
			...
			request.setAttribute("list", list);
	        RequestDispatcher rd = request.getRequestDispatcher("/searchdeceaselistadmin1.jsp");
	        rd.forward(request, response);
