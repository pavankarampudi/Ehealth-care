...
public class RelationSearchServletdoc extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public RelationSearchServletdoc() {
		super();
	}
	...
	public void service(HttpServletRequest request, HttpServletResponse response){
		...
		System.out.println(deceaseName);
			...
			ArrayList list=rsjb.relationSearch(deceaseName);
                        ...
                        RequestDispatcher rd = request.getRequestDispatcher("./relationdiagramdoc.jsp");
