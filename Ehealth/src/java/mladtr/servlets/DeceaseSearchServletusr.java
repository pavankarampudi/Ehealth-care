...
public class DeceaseSearchServletusr extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DeceaseSearchServletusr() {
		super();
	}
	public void service(HttpServletRequest request, HttpServletResponse response){
		...
		if((deceaseName!=null)&&!deceaseName.equals("")){
	        ...
	        RequestDispatcher rd = request.getRequestDispatcher("/searchdeceaselistusr.jsp");
			...
			request.setAttribute("list", list);
	        RequestDispatcher rd = request.getRequestDispatcher("/searchdeceaselistusr1.jsp");
	        rd.forward(request, response);
